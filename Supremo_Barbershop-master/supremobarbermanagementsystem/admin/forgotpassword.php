    ...
    <div class="card">
      ...
      <div class="card-body login-card-body">
        ...
        <div class="login-logo">
          <center><img src="company/supremo logo.jpg" width="150" height="130" class="user-image" alt="User Image"/></center>
        </div>
        <p class="login-box-msg"><strong style="color: black">Find your Account</strong></p>
