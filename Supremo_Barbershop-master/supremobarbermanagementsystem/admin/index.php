...
if(isset($_POST['login'])) 
{
  ...
  if($query->rowCount() > 0)
  {
    ...
    if(!empty($_POST["remember"])) {
      ...
      if($_SESSION['user_login'] != "userlog"){
      ...
      <div class="card">
        <div class="card-body login-card-body">
          <div class="login-logo">
            ...
            <center><img src="company/supremo logo.jpg" width="150" height="130" class="user-image rounded" alt="User Image"/></center>
          </div>
          <p class="login-box-msg"><b> <h4> <center> ADMIN PANEL </center></h4> </b></p>

          <form action="" method="post">
            <div class="input-group mb-3">
              <input type="text" name="username" class="form-control" placeholder="Username" required value="true<?php if(isset($_COOKIE["user_login"])) { echo $_COOKIE["user_login"]; } ?>">
            ...
            <div class="input-group mb-3">
              <input type="password" name="password" class="form-control" placeholder="Password" required value="true"<?php if(isset($_COOKIE["userpassword"])) { echo $_COOKIE["userpassword"]; } ?>">
              <div class="input-group-append">
                <div class="input-group-text">
