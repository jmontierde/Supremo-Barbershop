...
<body>
	...
	<section class="hero-wrap hero-wrap-2" style="background-image: url('supremo_images/services_img2.jpg');" data-stellar-background-ratio="0.5">
								...
								<div class="form-group">
									<div class="form-field">
										<div class="select-wrap">
											...
											<select name="barbername" id="barbername" class="form-control"required>
												<option value="">Select Barbers</option>
												<?php $query=mysqli_query($con,"select * from tblbarber");
												while($row=mysqli_fetch_array($query))
												{
													?>
													<option style="color: red;" value="<?php echo $row['BarberName'];?>" ><?php echo $row['BarberName'];?></option>
													<?php
												} ?> 
											</select> 
										</div>
